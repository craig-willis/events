...
{    
    ...
    public void getFeatures(int method) throws Exception
    {   
        ...
        { 
            ...
            for (double d: dfidf)
                avgDfidf += d;
            avgDfidf /= (double)dfidf.length    ;
                
            System.err.println(term);
            double[][] bursts = rutil.getBursts(dfidf, k, method);
            
            for (int j=0; j<k; j++) 
            {
                if (bursts[0].length < k) {
                    System.err.println("Error getting burst for " + term);
                    continue;
                }
                ...
                */
                System.out.println(term + "_" + j + "," + mu + "," + sigma + "," + avgDfidf);
            }    
        }                
    }
    ...
    /** 
     * Read the feature Dominant Period and Dominant Power Spectrum 
     * values into separate maps.
     */
